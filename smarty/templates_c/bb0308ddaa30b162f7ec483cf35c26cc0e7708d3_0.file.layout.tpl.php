<?php
/* Smarty version 3.1.29, created on 2016-03-31 12:26:45
  from "C:\wamp\www\Plug_IT\smarty\templates\layout.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_56fcfb65e17ea3_01768056',
  'file_dependency' => 
  array (
...
function content_56fcfb65e17ea3_01768056 ($_smarty_tpl) {
...
$_smarty_tpl->ext->_inheritance->processBlock($_smarty_tpl, 0, 'title', array (
  0 => 'block_88856fcfb65a14b03_79893587',
  1 => false,
  3 => 0,
  2 => 0,
));
...
$_smarty_tpl->ext->_inheritance->processBlock($_smarty_tpl, 0, 'head', array (
  0 => 'block_1492956fcfb65a2d836_43208805',
  1 => false,
  3 => 0,
  2 => 0,
));
...
?>
                            CAT : <?php echo $_smarty_tpl->tpl_vars['cat']->value->name;?>

                            <?php if ($_smarty_tpl->tpl_vars['cat']->value->name === $_GET['page']) {?>
                                <a href='/Plug_IT/index.php?page=Home'>Home</a> > <a href='/Plug_IT/index.php?page=<?php echo $_GET['page'];?>
...
$__foreach_subcat_4_saved_item = isset($_smarty_tpl->tpl_vars['subcat']) ? $_smarty_tpl->tpl_vars['subcat'] : false;
...
$__foreach_subcat_4_saved_local_item = $_smarty_tpl->tpl_vars['subcat'];
?>
                            SUBCAT : <?php echo $_smarty_tpl->tpl_vars['subcat']->value->name;?>

                            <?php if ($_smarty_tpl->tpl_vars['subcat']->value->name === $_GET['page']) {?>
                                <a href='/Plug_IT/index.php?page=Home'>Home</a> > <a href='/Plug_IT/index.php?page=<?php echo $_GET['page'];?>
'><?php echo $_smarty_tpl->tpl_vars['subcat']->value->name;?>
</a>
                            <?php }?>
                        <?php
$_smarty_tpl->tpl_vars['subcat'] = $__foreach_subcat_4_saved_local_item;
}
if ($__foreach_subcat_4_saved_item) {
$_smarty_tpl->tpl_vars['subcat'] = $__foreach_subcat_4_saved_item;
}
?>
                    <?php }?>
                <?php }?>
...
$_smarty_tpl->ext->_inheritance->processBlock($_smarty_tpl, 0, 'body', array (
  0 => 'block_1298256fcfb65dbc662_53773326',
  1 => false,
  3 => 0,
  2 => 0,
));
...
$__foreach_nav_7_saved_item = isset($_smarty_tpl->tpl_vars['nav']) ? $_smarty_tpl->tpl_vars['nav'] : false;
$_smarty_tpl->tpl_vars['nav'] = new Smarty_Variable();
$_smarty_tpl->tpl_vars['nav']->_loop = false;
foreach ($_from as $_smarty_tpl->tpl_vars['nav']->value) {
$_smarty_tpl->tpl_vars['nav']->_loop = true;
$__foreach_nav_7_saved_local_item = $_smarty_tpl->tpl_vars['nav'];
?>
                <li><a href="/Plug_IT/index.php?page=<?php echo $_smarty_tpl->tpl_vars['nav']->value->page;?>
"><?php echo $_smarty_tpl->tpl_vars['nav']->value->name;?>
</a></li>
                <?php
$_smarty_tpl->tpl_vars['nav'] = $__foreach_nav_7_saved_local_item;
}
if ($__foreach_nav_7_saved_item) {
$_smarty_tpl->tpl_vars['nav'] = $__foreach_nav_7_saved_item;
}
?>
...
function block_88856fcfb65a14b03_79893587($_smarty_tpl, $_blockParentStack) {
?>
Plug IT<?php
}
/* {/block 'title'} */
/* {block 'head'}  file:layout.tpl */
function block_1492956fcfb65a2d836_43208805($_smarty_tpl, $_blockParentStack) {
}
/* {/block 'head'} */
/* {block 'body'}  file:layout.tpl */
function block_1298256fcfb65dbc662_53773326($_smarty_tpl, $_blockParentStack) {
}
/* {/block 'body'} */
}
